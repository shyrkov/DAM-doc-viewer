 ...
 * 
 */
public class TestPdf2ImageICEpdf {
...
//                "w:/exploring/pdf2swf/sandbox/izpack-article-jm-3_06-95_99.PDF"));
//        PDPage page = (PDPage) pdf.getDocumentCatalog().getAllPages().get(0);
//        BufferedImage image = page.convertToImage(imageType, resolution);
//        ImageIO.write(image, imageFormat, new File("w:/exploring/pdf2swf/sandbox/111." + imageFormat));
        
        Document document = new Document();
        document.setFile(new File(
              "w:/exploring/pdf2swf/sandbox/test.pdf").getPath());
        
        BufferedImage image = (BufferedImage) document.getPageImage(
                0, GraphicsRenderingHints.PRINT, Page.BOUNDARY_CROPBOX, 0, 1);
        
        ImageIO.write(image, imageFormat, new File("w:/exploring/pdf2swf/sandbox/test_icepdf." + imageFormat));

 ...
 * 
 */
public class TestPdf2ImagePdfboxIJ {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File output = new File("w:/exploring/pdf2swf/sandbox/" + fileName
                + "." + imageFormat);
        ImageIO.write(image, imageFormat, output);
        generateThumbnailIJ(output, new File("w:/exploring/pdf2swf/sandbox/" + fileName
              + "b." + imageFormat), 150);
        generateThumbnailIJ(output, new File("w:/exploring/pdf2swf/sandbox/" + fileName
                + "b_2." + imageFormat), 350);
...
//        thumbnail.flush();
    ...
    public static void generateThumbnailIJ(File img, File out, int size) {
        ImagePlus ip = new Opener().openImage(img.getPath());
        ...
        new FileSaver(ip).saveAsJpeg(out.getPath());
    }
}
